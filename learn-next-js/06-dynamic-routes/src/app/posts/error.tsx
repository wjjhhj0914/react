    ...
    >
      ...
      >
        <div className="p-6">
          ...
          <div
            className="h-0.5 w-16 bg-orange-500/50 mx-auto mb-4"
            aria-hidden="true"
          />

          <div className="text-orange-100/80 text-center mb-6 font-light">
            <p>{error.message}</p>
            {error.digest && (
              <p className="mt-2 text-xs text-orange-300/60 font-mono">
