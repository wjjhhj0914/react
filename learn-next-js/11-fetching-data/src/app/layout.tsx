    ...
    <nav className="container mx-auto p-4">
      ...
      <ul className="flex gap-x-4 [&_a:hover]:text-amber-400">
        ...
        <li className="relative group">
          <NavLink href="/fetching-data" exact>
            데이터 페칭
          </NavLink>
          <ul
            className={`
              hidden 
              absolute left-0 w-[27ch] 
          ...
          >
            <li>
              <NavLink href="/fetching-data/server-component">
                서버 컴포넌트에서 가져오기
              </NavLink>
            </li>
            <li>
              <NavLink href="/fetching-data/database">
                데이터베이스에서 직접 가져오기
              </NavLink>
            </li>
            <li>
              <NavLink href="/fetching-data/client-component">
                클라이언트 컴포넌트에서 가져오기
              </NavLink>
            </li>
          </ul>
